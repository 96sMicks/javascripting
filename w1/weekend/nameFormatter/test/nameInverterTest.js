...
describe('nameInverter', function() {
  ...
  it("should return a honrific last-name, first-name when passed honorific first-name last-name", function() {
  ...
  it("should throw an error when is undefined", function() {
